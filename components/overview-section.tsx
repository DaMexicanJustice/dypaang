...
import { ImageIcon, Video, Brain, BookOpen, ArrowRight, Sparkles, Home } from "lucide-react"
        ...
        <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
          <CardContent className="p-6">
            <div className="flex items-center justify-center gap-2 mb-3">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Welcome to PromptCraft</h3>
            </div>
            <p className="text-gray-600">
              Your AI-powered assistant for creating perfect prompts. Navigate through our tools using the sidebar menu,
